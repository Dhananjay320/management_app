...
const emailSchema = new mongoose.Schema({
  ...
  references: { type: String }, // RFC 2822 References header (space-separated message-IDs)

  // SMTP delivery confirmation (Session 6)
...
// Session 16 (C6): include bodyText for deep email search, with weighted ranking.
emailSchema.index(
  { subject: 'text', fromName: 'text', bodyText: 'text' },
  { weights: { subject: 10, fromName: 5, bodyText: 2 } }
);
