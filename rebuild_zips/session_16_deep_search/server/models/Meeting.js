...
// Session 16 (C6): text search on title + agenda
meetingSchema.index({ title: 'text', agenda: 'text' }, { weights: { title: 10, agenda: 3 } });
...
const momSchema = new mongoose.Schema({
  ...
  lastAutoSaveAt: { type: Date },  // Session 8: for UI "Saved just now" feedback
...
// Session 16 (C6): deep search into MoM bodies
momSchema.index({ title: 'text', plainTextContent: 'text' }, { weights: { title: 10, plainTextContent: 3 } });
