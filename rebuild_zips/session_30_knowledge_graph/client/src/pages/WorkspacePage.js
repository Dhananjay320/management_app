...
// Session 30 (N5): knowledge-graph backlinks panel
  ...
  if (editingDoc) {
    return (
      <div className="ad-ws">
        ...
        <DocumentEditor
          doc={editingDoc}
          onSave={() => openWorkspace(selectedWs)}
    ...
    <div className="ad-ws">
      ...
      <header className="ad-ws__head ad-enter" style={{ marginTop: 8 }}>
        ...
        <div className="ad-ws__head-right">
          ...
          {/* Session 30 (N5): link to knowledge graph */}
          <a
            href={`/workspace/graph/${selectedWs}`}
            className="badge-pill"
            style={{ background: 'rgba(139, 92, 246, 0.14)', color: '#A5B4FC', textDecoration: 'none' }}
          >
            🌐 Graph
          </a>
        </div>
...
function DocumentEditor({ doc, onSave, onOpenDoc }) {
  ...
  return (
    <div className="ad-ws-doc-edit">
      ...
      {/* Session 30 (N5): linked mentions + outgoing [[backlinks]] */}
      <BacklinksPanel docId={doc._id} onOpenDoc={onOpenDoc} />
    </div>
  );
}
