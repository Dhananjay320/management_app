    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-actions">
          ...
          {/* Session 10: shortcut to the dedicated powers editor with admin
              title/scope and the full power catalog (not just the subset above). */}
          {id && (
            <button
              type="button"
              className="btn btn-secondary"
              onClick={() => navigate(`/admin/users/${id}/powers`)}
              title="Open the full powers & admin-scope editor"
            >
              Open powers editor →
            </button>
          )}
