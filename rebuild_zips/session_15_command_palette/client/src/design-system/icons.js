...
//
// Usage: <Icon.Bell size={16} />   or   <Icon name="bell" size={16} />

import React from 'react';

const makeIcon = (paths, defaultViewBox = '0 0 24 24') => {
  return function IconInner({ size = 16, stroke = 'currentColor', strokeWidth = 2, className = '', style = {}, ...rest }) {
    return (
      <svg
...
export const StickyIcon = makeIcon(
  <>
    <path d="M15 3v4a2 2 0 0 0 2 2h4" />
    <path d="M18 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8l6 6v10a2 2 0 0 1-2 2z" />
    <path d="M8 13h5" />
    <path d="M8 17h3" />
  </>
);
...
export const Newspaper = makeIcon(
  <>
...
export const Plus = makeIcon(<><line x1="12" x2="12" y1="5" y2="19" /><line x1="5" x2="19" y1="12" y2="12" /></>);
export const X = makeIcon(<><path d="M18 6 6 18" /><path d="m6 6 12 12" /></>);
export const ArrowRight = makeIcon(<><line x1="5" x2="19" y1="12" y2="12" /><polyline points="12 5 19 12 12 19" /></>);
...
export const Zap = makeIcon(<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />);
