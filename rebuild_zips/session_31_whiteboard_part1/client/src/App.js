...
// Session 24 N3: scheduled messages management page
import ScheduledMessagesPage from './pages/ScheduledMessagesPage';
// Session 25 N4: social follow pages
import FollowingPage from './pages/FollowingPage';
import UserProfilePage from './pages/UserProfilePage';
// Session 27 N6: wellness page
import WellnessPage from './pages/WellnessPage';
// Session 28 N8: gamification
import GamificationPage from './pages/GamificationPage';
import AchievementToast from './components/AchievementToast';
// Session 29 N7: content hub
import ContentHubPage from './pages/ContentHubPage';
import ContentDetailPage from './pages/ContentDetailPage';
import ContentEditorPage from './pages/ContentEditorPage';
// Session 30 N5: knowledge graph view
import WorkspaceGraphPage from './pages/WorkspaceGraphPage';
// Session 31 N2: whiteboards
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
            ...
            <Route path="social" element={<FollowingPage />} />
            ...
            <Route path="workspace/graph/:id" element={<WorkspaceGraphPage />} />
