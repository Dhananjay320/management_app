...
import './AnalysisPage.restyle.css';
...
export default function AnalysisPage() {
  ...
  return (
    <div className="ad-ana">
      <header className="ad-ana__head ad-enter">
        <div className="ad-ana__head-left">
          <h1 className="ad-ana__title"><GradientText>Analysis</GradientText></h1>
          <p className="ad-ana__sub">Attendance, tasks, and performance insights</p>
        </div>
      </header>

      {/* Tabs */}
      <div className="ad-ana__tabs">
        <SegmentedControl
          value={tab}
          onChange={setTab}
      ...
      {/* Content */}
      {loading ? (
        <GlassPanel elevated className="ad-ana__state">Loading…</GlassPanel>
      ) : (
        <>
