        ...
        <>
          ...
          {records.length === 0 ? (
            <div className="sal-empty">
              ...
              <h3 style={{ fontSize: 16, fontWeight: 700, color: '#1E293B', marginBottom: 6 }}>No salary records</h3>
              <p style={{ fontSize: 12, color: '#94A3B8' }}>Salary records for {year} will appear here once generated by admin.</p>
            </div>
          ) : (
            <>
